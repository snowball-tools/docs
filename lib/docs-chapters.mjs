export const outline = [
  ...
  },
  {
    ...
    headers: [
      {
        id: 'in-app-wallets/introduction',
        href: '/docs/in-app-wallets/introduction',
        title: 'Introduction',
        breadcrumbs: ['Introduction'],
        meta: { title: 'Introduction to Snowball In-App Wallets' },
      },
      {
        id: 'in-app-wallets/concepts',
        href: '/docs/in-app-wallets/concepts',
        title: 'Concepts',
        breadcrumbs: ['Concepts'],
        meta: { title: 'Snowball In-App Wallets: Concepts' },
      },
      {
        id: 'in-app-wallets/getting-started',
        href: '/docs/in-app-wallets/getting-started',
        title: 'Getting Started',
        breadcrumbs: ['Getting Started'],
        meta: { title: 'Getting Started with Snowball\'s In-App Wallets' },
      },
    ]
  },
  {
  ...
  },
  {
    ...
    headers: [
      {
        id: 'security/in-app-wallets',
        href: '/docs/security/in-app-wallets',
        title: 'Security: In-App Wallets',
        breadcrumbs: ['Security: In-App Wallets'],
        meta: { title: 'Snowball Security: In-App Wallets' },
      },
    ]
  },
]
