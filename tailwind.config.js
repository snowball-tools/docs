...
function expandJsExtensions(path) {
  return [`${path}.js`, `${path}.jsx`, `${path}.ts`, `${path}.tsx`, `${path}.mjs`, `${path}.cjs`]
}
...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        m: '0px 0px 0px 1px #E8F0F7, 0px 2px 4px 0px rgba(8, 47, 86, 0.04)',
        card: '0px 2px 4px 0px #082F560A',
        button: '0px 0px 4px 0px rgba(255, 255, 255, 0.25) inset, 0px -2px 0px 0px rgba(0, 0, 0, 0.04) inset',
        ...
        modal:
          '0px 11px 16px 0px var(--border-interactive, rgba(8, 47, 86, 0.10)), 0px 0px 12px 0px var(--border-interactive-hovered, rgba(8, 47, 86, 0.14));',
      },
    },
  },
